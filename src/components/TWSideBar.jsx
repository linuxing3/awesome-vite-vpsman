  ...
  return (
    <>
      ...
      <Sidenav isOpen={isOpen} toggle={toggle}>
        <Sidenav.Item href="/components/twbutton">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
        ...
        <Sidenav.Item href="/components/twform">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
        ...
        <Sidenav.Item href="/components/twcard">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
        ...
        <Sidenav.Item href="/components/twtoast">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
          ...
          <span className="pl-2">Toast</span>
        </Sidenav.Item>
      </Sidenav>
    </>
  );
